...
<body>
		...
		<div class="container py-xl-5 py-lg-3">
			<div class="row py-md-5">
				...
				<div class="col-xl-6 col-lg-7 about-right offset-xl-1">
					...
					<h3 class="tittle-w3layouts text-uppercase pr-lg-5 mt-2">Book Luxury and Budget-Friendly Villas</h3>
					<p class="mt-4 mb-4">Your search for a luxury villa, holiday home or homestay
						 on rent is now over. Explore StayVista
						 which manages 350+ Homes in India. Book Now!</p>
	...
	<div class="team text-center py-5" id="team">
		<div class="container py-xl-5 py-lg-3">
			...
			<p class="sub-tittle text-center mt-2 mb-sm-5 mb-4 pb-xl-3">We have a team of warm 
				and friendly staff members enabling you to make the most of your stay 
				at Over Water Villas. Our villa staff ensures a memorable</p>
				...
				<div class="col-lg-4 col-md-6 team-gd-info">
					<div class="team-gd">
						...
						<div class="team-info">
							...
							<p>We were a group of friends. Had an amazing time. A very nice swimming pool. 
								Very friendly care taker as well. Very peaceful.</p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 team-gd-info mt-md-0 mt-5">
					<div class="team-gd">
						...
						<div class="team-info">
							...
							<p>Very good, good location nice pool</p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 mx-lg-0 mx-md-auto team-gd-info mt-lg-0 mt-5">
					<div class="team-gd">
						...
						<div class="team-info">
							...
							<p>Very good service, nice rooms and pool are clean...total privacy.</p>
						</div>
					</div>
				</div>
			</div>
