            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="bookdb.php">Booking</a></li>
						<li><a href="bankdb.php">Bank Details</a></li>
						<li><a href="carddb.php">Card Details</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="chartjs.html">Bookings</a></li>
                        <li><a href="flot_chart.html">Financial Growth</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
                        <li><a href="google_map.html">Other Branches</a></li>
						...
						<div class="stats-info-agileits">
							...
							<div class="stats-body">
								<ul class="list-unstyled">
									...
									<li>Brave <span class="pull-right">78%</span>  
										<div class="progress progress-striped active progress-right">
							...
							<table class="table stats-table ">
								...
								<tbody>
									...
									<tr>
										<th scope="row">5</th>
										<td>Lisa Lisa</td>
										<td><span class="label label-success">Canceled</span></td>
										<td><h5 class="down">10% <i class="fa fa-level-down"></i></h5></td>
									</tr>
									<tr>
										<th scope="row">6</th>
										<td>Polnareff</td>
										<td><span class="label label-warning">Payment Done</span></td>
