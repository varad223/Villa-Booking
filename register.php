...
//$password=md5($_POST["password"]);
  require 'db.php';
    $insert_query= "insert into regis(fname,lname,email,number,password)values('$fname','$lname','$email','$number','$password')";
  ...
  //  echo $insert_query."<br>";  
    ...
    if($fire_query)
    {
      ...
      echo 'alert("Succesfully User Added")';
...
<div class="signup-form">
    <form method="POST" action="<?php $_SERVER['PHP_SELF'] ?>" >
        ...
        <div class="form-group">
         ...
         <div class="form-group">
        	<input type="numeric" class="form-control" name="number" placeholder="Mobile Number" required="required">
        </div>
		<div class="form-group">
